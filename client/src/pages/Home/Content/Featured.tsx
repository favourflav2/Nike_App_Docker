      ...
      <div className="w-full h-full flex flex-col">
        ...
        <div className="w-full grid md:grid-cols-[49.5%_1%_49.5%] grid-cols-1 md:gap-0 gap-4">
          ...
          <div className="group relative w-full cursor-pointer">
            ...
            <div className=" absolute flex flex-col bottom-10 left-6  text-black group-hover:hidden">
            ...
            {/* Image Overlay */}
            <div className="absolute hidden top-0 left-0 w-full sm:flex flex-col h-full opacity-0 group-hover:opacity-100 duration-300 group-hover:bg-black/50 items-center  text-gray-300">
              <div className="w-full h-full relative">
                <div className=" absolute flex flex-col bottom-10 left-6  text-white">
                  ...
                  <button className="text-black bg-white p-2 rounded-3xl hover:bg-black hover:text-white">
                    Shop
                  </button>
                </div>
              </div>
          ...
          <div className="group relative w-full cursor-pointer ">
            ...
            <div className=" absolute flex flex-col bottom-10 left-6  text-white group-hover:hidden">
              ...
              <button className="text-white bg-black p-2 rounded-3xl w-[70%]">
                Shop
              </button>
            </div>
