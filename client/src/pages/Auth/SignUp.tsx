...
export default function SignUp(props: ISignUpProps) {
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center">
      {/* Content */}
      <form className="max-w-[470px] h-full pb-20 flex flex-col justify-center" onSubmit={(e) => handleSubmit(e)}>
        {/* Images */}
        ...
        <h1 className="mb-8">Already Have An Account? <span className="font-semibold cursor-pointer underline hover:text-gray-600" onClick={()=>dispatch(setError())}><Link to="/login">Login</Link></span></h1>
        {/* First and Last Name */}
        ...
        <div className="w-full justify-end flex mt-10">
          <button disabled={loading} className="p-3 bg-black text-white hover:bg-gray-700 cursor-pointer rounded-full font-semibold">{loading ? "Loading...":"Create Account"}</button>
        </div>
      </form>
    </div>
  );
