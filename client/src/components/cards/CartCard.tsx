...
export default function CartCard({ item }: ICartCardProps) {
  ...
  //console.log(item)
  return (
    <div className="w-full h-auto flex flex-col my-1 border border-gray-200 p-1 rounded-md">
      {/* Image and Name Box */}
      <div className="w-full flex items-center h-auto">
        {/* Image Right Side */}
        <div className="lg:w-[180px] max-w-[200px] h-auto ">
          <img src={item.img} alt="" className="object-cover  lg:w-[180px] w-full " />
        </div>

        {/* Right Sider Name */}
        <div className="w-full flex flex-col h-auto px-1 ">
          {/* Name and Price*/}
